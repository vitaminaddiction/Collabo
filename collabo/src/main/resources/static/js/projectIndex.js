const loadFunc = (project, TODOList, ongoingTODOList, doneTODOList) => {
            ...
            countItem(doneTODOList, countTotal);
            countItem(doneTODOList, countDone);

            const ratioDoneTotal = countDone.map((done, index) => ((done / countTotal[index]) * 100).toFixed(2));
